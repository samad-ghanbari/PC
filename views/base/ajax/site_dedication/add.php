...
<div class="prj-sitex-ded-add">
    ...
    <div class="d-md-flex flex-column align-items-center dir-rtl justify-content-center w-100 h-100 max-width-1000px mx-auto">
        <?php $form = ActiveForm::begin([
            'id' => 'prj-sitex-ded-add',
            'method'=>'POST',
            'action'=>Yii::$app->request->baseUrl."/base/add_sd",
        ...
        <?= $form->field($model, 'project_dedication_id')->hiddenInput(['name'=>'pdid'])->label(false); ?>
